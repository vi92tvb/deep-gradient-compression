...
from torchpack.mtpack.datasets.vision import VietnameseTextTransformer
from torchpack.mtpack.utils.config import Config, configs

# dataset
configs.dataset = Config(VietnameseTextTransformer)
configs.dataset.root = './data/vietnamesetexttransformer'
